...
public class View extends JFrame implements ActionListener {
    ...
    public void showAbout() {
        JOptionPane.showMessageDialog(this, "Созданный за пару дней хтмл редактор, просто хотел понять насколько хорошо у меня получится :)", "О программе", JOptionPane.INFORMATION_MESSAGE);
    }
